...
from models.CMFNet import Config as Config_CMFNet

class Channel_Embeddings(nn.Module):
    """Construct the embeddings from patch, position embeddings.
    """

    def __init__(self, Config_CMFNet, patchsize, img_size, in_channels):
        super().__init__()
        ...
        self.dropout = Dropout(Config_CMFNet.transformer["embeddings_dropout_rate"])
...
class Attention_org(nn.Module):
    def __init__(self, Config_CMFNet, vis, channel_num):
        super(Attention_org, self).__init__()
        self.vis = vis
        self.KV_size = Config_CMFNet.KV_size
        self.channel_num = channel_num
        self.num_attention_heads = Config_CMFNet.transformer["num_heads"]
        ...
        for _ in range(Config_CMFNet.transformer["num_heads"]):
        ...
        self.attn_dropout = Dropout(Config_CMFNet.transformer["attention_dropout_rate"])
        self.proj_dropout = Dropout(Config_CMFNet.transformer["attention_dropout_rate"])
...
class Mlp(nn.Module):
    def __init__(self, Config_CMFNet, in_channel, mlp_channel):
        super(Mlp, self).__init__()
        self.fc1 = nn.Linear(in_channel, mlp_channel)
        self.fc2 = nn.Linear(mlp_channel, in_channel)
        self.act_fn = nn.GELU()
        self.dropout = Dropout(Config_CMFNet.transformer["dropout_rate"])
        self._init_weights()
...
class Block_ViT(nn.Module):
    def __init__(self, Config_CMFNet, vis, channel_num):
        ...
        expand_ratio = Config_CMFNet.expand_ratio
        ...
        self.attn_norm = LayerNorm(Config_CMFNet.KV_size, eps=1e-6)
        self.channel_attn = Attention_org(Config_CMFNet, vis, channel_num)
        ...
        self.ffn1 = Mlp(Config_CMFNet, channel_num[0], channel_num[0] * expand_ratio)
        self.ffn2 = Mlp(Config_CMFNet, channel_num[1], channel_num[1] * expand_ratio)
        self.ffn3 = Mlp(Config_CMFNet, channel_num[2], channel_num[2] * expand_ratio)
        self.ffn4 = Mlp(Config_CMFNet, channel_num[3], channel_num[3] * expand_ratio)
...
class Encoder(nn.Module):
    def __init__(self, Config_CMFNet, vis, channel_num):
        ...
        for _ in range(Config_CMFNet.transformer["num_layers"]):
            layer = Block_ViT(Config_CMFNet, vis, channel_num)
...
class ChannelTransformer(nn.Module):
    def __init__(self, Config_CMFNet, vis, img_size, channel_num=[64, 128, 256, 512], patchSize=[32, 16, 8, 4]):
        super().__init__()
        ...
        self.embeddings_1 = Channel_Embeddings(Config_CMFNet, self.patchSize_1, img_size=img_size, in_channels=channel_num[0])
        self.embeddings_2 = Channel_Embeddings(Config_CMFNet, self.patchSize_2, img_size=img_size // 2,
                                               in_channels=channel_num[1])
        self.embeddings_3 = Channel_Embeddings(Config_CMFNet, self.patchSize_3, img_size=img_size // 4,
                                               in_channels=channel_num[2])
        self.embeddings_4 = Channel_Embeddings(Config_CMFNet, self.patchSize_4, img_size=img_size // 8,
                                               in_channels=channel_num[3])
        self.encoder = Encoder(Config_CMFNet, vis, channel_num)
...
class Block_ViT_cross(nn.Module):
    def __init__(self, Config_CMFNet, vis, channel_num):
        ...
        self.attn_normx = LayerNorm(Config_CMFNet.KV_size, eps=1e-6)
        self.attn_normy = LayerNorm(Config_CMFNet.KV_size, eps=1e-6)
        self.channel_attn = Attention_org_cross(Config_CMFNet, vis, channel_num)
        ...
        self.ffn3 = Mlp(Config_CMFNet, channel_num[2], channel_num[2] * expand_ratio)
        self.ffn4 = Mlp(Config_CMFNet, channel_num[3], channel_num[3] * expand_ratio)
        self.ffnd1 = Mlp(Config_CMFNet, channel_num[0], channel_num[0] * expand_ratio)
        self.ffnd2 = Mlp(Config_CMFNet, channel_num[1], channel_num[1] * expand_ratio)
        self.ffnd3 = Mlp(Config_CMFNet, channel_num[2], channel_num[2] * expand_ratio)
        self.ffnd4 = Mlp(Config_CMFNet, channel_num[3], channel_num[3] * expand_ratio)
...
class Encoder_cross(nn.Module):
    def __init__(self, Config_CMFNet, vis, channel_num):
        ...
        self.encoder_norm4 = LayerNorm(channel_num[3], eps=1e-6)
        for _ in range(Config_CMFNet.transformer["num_layers"]):
            layer = Block_ViT_cross(Config_CMFNet, vis, channel_num)
            self.layer.append(copy.deepcopy(layer))
...
class ChannelTransformer_cross(nn.Module):
    def __init__(self, Config_CMFNet, vis, img_size, channel_num=[64, 128, 256, 512], patchSize=[32, 16, 8, 4]):
        ...
        self.embeddingsd_1 = Channel_Embeddings(Config_CMFNet, self.patchSize_1, img_size=img_size, in_channels=channel_num[0])
        self.embeddingsd_2 = Channel_Embeddings(Config_CMFNet, self.patchSize_2, img_size=img_size // 2,
                                                in_channels=channel_num[1])
        self.embeddingsd_3 = Channel_Embeddings(Config_CMFNet, self.patchSize_3, img_size=img_size // 4,
                                                in_channels=channel_num[2])
        self.embeddingsd_4 = Channel_Embeddings(Config_CMFNet, self.patchSize_4, img_size=img_size // 8,
                                                in_channels=channel_num[3])
        self.encoder = Encoder_cross(Config_CMFNet, vis, channel_num)
